 ...
 * @author m.gond
 */
public class JeoSearchResourceModel extends ResourceModel {
   ...
   */
  public JeoSearchResourceModel() {
    super();
    setClassAuthor("AKKA Tecnologies");
    setClassOwner("CNES");
    setClassVersion("0.2");
    setName("JeoSearchResourceModel");
    setDescription("GEO JSON export on the fly");
    setResourceClassName("fr.cnes.sitools.ext.jeobrowser.search.resources.JeoSearchResource");
